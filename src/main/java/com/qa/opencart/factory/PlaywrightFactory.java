...
public class PlaywrightFactory {
	...
	public Page initBrowser(Properties prop) {
		...
		case "chromium":
			/**
			 * Basically what we are doing is we create a browser context and in that
			 * context we initialize a page instance so this page can interacts elements
			 * inside that browser
			 */
		...
		// set method will initialize BrowserContext from getBrowser()
	...
	public Properties init_prop() {
		...
		try {
			...
			prop = new Properties();
			// this prop variable will load all properties from fileinput stream class as
			// key and value
			prop.load(ip);
